...
<head>
	...
	<title>Man and van London</title>
	...
	<?php
		$file = '../mymagicremovals_lib/counter.txt';
...
<div id="main_wrapper">
	...
	<section class="content_section page_title">
		<div class="content clearfix">
			<h1 class="">Man and van London</h1>
			<div class="breadcrumbs">
				<a href="http://mymagicremovals.co.uk/">Home</a>
	...
	<section class="content_section">
		...
		<div class="container">
		    <div class="section-title text-left">
				...
				<form method="post" id="detailForm" action="index-quote-2.php" onsubmit="if(document.getElementById('termsAndConditions').checked) { return true; } else { alert('Please indicate that you have read and agree to the Terms and Conditions'); return false; }">		
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<?php 
								...
								$vanSize = array("34"=>"Small L2.3m x W1.7m x H1.4m", 
												 "39"=>"Large L4m x W1.7m x H1.8m", 
												 "44"=>"Luton L4m x W2m x H2.2m");
