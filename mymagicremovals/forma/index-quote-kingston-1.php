...
<head>
	...
	<title>Man and van Kingston</title>
	...
	<?php
		$file = '../mymagicremovals_lib/kingstonCounter.txt';
...
<div id="main_wrapper">
	...
	<section class="content_section page_title">
		<div class="content clearfix">
			<h1 class="">Man and van Kingston</h1>
			<div class="breadcrumbs">
				<a href="http://manandvankingston.biz/">Home</a>
	...
	<section class="content_section">
		...
		<div class="container">
		    <div class="section-title text-left">
				...
				<form method="post" id="detailForm" action="index-quote-kingston-2.php" onsubmit="if(document.getElementById('termsAndConditions').checked) { return true; } else { alert('Please indicate that you have read and agree to the Terms and Conditions'); return false; }">		
					<div class="row">
